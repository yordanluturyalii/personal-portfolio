...
import { ChevronDown, Download, Github, Linkedin, Mail, Code, Award, Users, Clock, Calendar, MapPin, ExternalLink, Phone, Send} from "lucide-react"
  ...
  const experiences = [
    {
      ...
      technologies: ["Laravel", "jQuery", "AJAX", "Alpine.js", "Blade", "Filament", "Livewire"],
    },
    {
      title: "Software Engineer Intern",
      ...
      location: "Hybrid",
      description: "Developed RESTful APIs and mobile attendance app, created fully functional LMS using Next.js.",
      achievements: [
      ...
      technologies: ["Laravel", "Next.js", "FlutterFlow", "Xendit", "MUX", "Prisma", "PostgreSQL", "Shadcn"],
    },
    {
      ...
      location: "Remote",
      description: "Developed responsive admin dashboard for AC service bookings and maintained RESTful APIs.",
      achievements: [
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-5xl md:text-7xl font-bold text-gray-900 leading-tight">
                Hi, I'm{" "}
                <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Yordan</span>
              </h1>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              A passionate fresh graduate with 2+ years of hands-on experience in developing and maintaining web
              applications using Laravel, React, and Next.js.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                I'm a fresh graduate with over 2 years of hands-on experience in developing and maintaining web
                applications using Laravel, React, and Next.js. I've built and contributed to real-world projects such as
                the BeetleHR Lite API, AC service booking dashboard, Eduleap LMS, and a badminton court reservation app.
              </p>

              <p className="text-lg text-gray-700 leading-relaxed">
                I'm recognized for achievements in software development, including 1st Place in the 2024 Semarang City Web
                Technologies Competition (LKS) and 1st Place in the 2023 Techcompfest National Web Design Competition.
              </p>

              <p className="text-lg text-gray-700 leading-relaxed">
                I'm passionate about exploring new technologies and eager to contribute in dynamic and collaborative
                startup or software house environments.
              </p>
            </div>
      ...
      <section id="experience" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              My journey through various internships and projects that shaped my skills
            </p>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+6281944582397" className="text-gray-600 hover:text-blue-600 transition-colors">
                        +62 819 4458 2397
                      </a>
                    </div>
                  </div>
